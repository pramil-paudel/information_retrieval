...
class TweetIrs:
    def __init__(self):
        ...
        self.stemmer_output = ""
        self.stemmed_ranked_document = ""
        self.raw_ranked_document = ""
    ...
    def tfidf_and_vector_space_model(self, query):
        output_dict = vector_space_model.run_data_file(self.stemmer_output, query)
